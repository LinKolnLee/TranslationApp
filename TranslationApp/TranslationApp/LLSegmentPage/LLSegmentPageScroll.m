...
@interface LLSegmentPageScroll()<NSCacheDelegate,UIScrollViewDelegate>
{
...
@end
@implementation LLSegmentPageScroll
...
- (void)setupSubview {
    ...
    [self setContentSize:CGSizeMake(_viewsArray.count *self.width, 0)];
